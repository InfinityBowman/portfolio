    ...
    <section id="work" ref={containerRef}>
      ...
      <div className="grid gap-8">
        {CASE_STUDIES.map((study) => (
          <div
            key={study.title}
            className="case-study grid gap-6 sm:grid-cols-2 items-center p-6 rounded-xl border border-accent bg-background/60 backdrop-blur-sm"
          >
            <div className="order-2 sm:order-1">
              <h3 className="text-xl font-semibold text-primary mb-3">{study.title}</h3>
