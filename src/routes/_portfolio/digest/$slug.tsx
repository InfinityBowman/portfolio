...
export const Route = createFileRoute('/_portfolio/digest/$slug')({
  ...
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        {
          property: 'og:url',
          content: `https://jacobmaynard.dev/digest/${loaderData.slug}`,
        },
      ...
      links: [
        {
          rel: 'canonical',
          href: `https://jacobmaynard.dev/digest/${loaderData.slug}`,
        },
      ],
